<template>
	<view class="shopping">
		<view>
			<uni-nav-bar left-icon="back"  title="购物车" right-text="编辑"></uni-nav-bar>
		</view>
		<view class="act">
			<p><span id="sub">满减</span>满69元，减10元<span id="see">查看活动<cmd-icon type="chevron-right" size="30" color="#bebebe"></cmd-icon></span></p>
		</view>
		<view class="shop_all">
			<view class="chec">
			    <checkbox-group>
			        <label class="hobo">
			            <checkbox value="cb"  color="#FFCC33" style="transform:scale(0.7);border-radius: 50%;" class="hobo" />
			        </label>
			    </checkbox-group>
			</view>
			<view><image class="goods" src="../../static/pingguo.jpg"></image></view>
			<view class="details">
				<view class="details_text">
					<span>
						<h5>美国新奇士(Sunkist)红心橙 约600g</h5>
						<span id="cation">规格：约600g</span>
					</span>
				</view>
				<view class="price">
					<view><span id="price_l">￥20.0</span></view>
		...
		<view class="shop_all">
			<view class="chec">
			    <checkbox-group>
			        <label>
			            <checkbox value="cb"  color="#FFCC33" style="transform:scale(0.7);border-radius: 100%;" />
			        </label>
			    </checkbox-group>
			</view>
			<view><image class="goods" src="../../static/pingguo.jpg"></image></view>
		...
		<view class="footer">
			...
			<view class="f_r">
				<view class="f_r_left">
					合计：<span>￥78.00</span><br/>
					<span id="yiyouhui">已优惠：-10.00</span>
				</view>
				<view class="f_r_right"><navigator url="/pages/index/sure_order" open-type="navigate"><button>去结算</button></navigator></view>
			</view>
		</view>
